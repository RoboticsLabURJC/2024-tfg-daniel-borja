...
def densify_point_cloud(points: np.ndarray, remissions: np.ndarray, 
    ...
    for _ in range(num_new_points):
        ...
        #print(f"Punto vecino encontrado [{indices[0][1]}]: {neighbor_point}")
        #print(f"Distancia al vecino: {neighbor_distance}")
        
        # Interpolar entre el punto original y el vecino seleccionado aplicando C = A + α(B - A)
